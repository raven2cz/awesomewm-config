#+TITLE: Fishlive's AwesomeWM Config
...
- [[#awesomewm-configuration][AwesomeWM Configuration]]
...
+ lain layouts+basic-widgets from orig master (standard usage of lain awesome project) [[https://github.com/lcpz/lain][lcpz/lain]] - standard still good ;-)
...
+ *Nice Titlebars component* - Nice wonderful titlebar component with many features added. Creator: [[https://github.com/mut-ex/awesome-wm-nice][mut-ex/awesome-wm-nice]] :grinning:
