    ...
    item_template = {
        ...
        update_callback = function(self, item, menu)
            ...
            local style = item.active
                and (item.selected
                    and theme.capsule.styles.active_selected
                    or theme.capsule.styles.active)
                or (item.urgent
                    and (item.selected
                        and theme.capsule.styles.urgent_selected
                        or theme.capsule.styles.urgent)
                    or (item.selected
                        and theme.capsule.styles.normal_selected
                        or theme.capsule.styles.normal))
